...
func ContainerPut(ctx *daprworkflow.WorkflowContext) (any, error) {
	...
	return containerPut(ctx, &workitem)
}

func containerPut(ctx *daprworkflow.WorkflowContext, workitem *reconciler.WorkItem) (*reconciler.Result, error) {
